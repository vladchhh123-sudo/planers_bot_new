...
☄️ <b>Экосистема роста</b> — все планеры всего за <b>349 р.</b> вместо <s>4 950 р.</s>
...
👇""",
        "buttons": (("БЕРУ НАБОР ЗА 349 Р.", "bundle:ecosystem"),),
    },
    {
        "code": "r048",
        "hours": 48,
...
<b>149 р.</b> — это сумма, которую легко потратить за один вечер и даже не заметить.
...
<b>Ещё 12 часов цена остаётся 149 р. Потом — 790 р.</b>

👇""",
        "buttons": (("ЗАБРАТЬ ПЛАНЕР ЗАДАЧ ЗА 149 Р.", "product:tasks"),),
    },
    {
        "code": "r072",
        "hours": 72,
...
<b>Специально для тебя цена всё ещё сохранена. Новые покупатели уже приобретают планеры по стандартной стоимости — от 790 р. до 1 190 р.</b>
...
<b>Пока ещё 149 р. Скоро цена изменится.</b>
...
<b>Планер задач — всего 149 р. вместо 790 р.</b>

Попробуй. Возможно, именно этого сейчас и не хватает.

👇""",
        "buttons": (("ПОПРОБОВАТЬ ЗА 149 Р.", "product:tasks"),),
    },
    {
        "code": "r145",
        "hours": 145,
